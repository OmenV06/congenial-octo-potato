...
import net.omen.eclipsemod.item.custom.misc.EboniteIngotItem;
import net.omen.eclipsemod.item.custom.misc.IlluminiteIngotItem;
import net.omen.eclipsemod.item.custom.misc.SteelIngotItem;
import net.omen.eclipsemod.item.custom.misc.SteelNuggetItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> KATANA_OF_WIND = ITEMS.register("katana_of_wind", KatanaOfWindItem::new); //Make gui icon change from handle to handle and blade, and finish hitblock method
