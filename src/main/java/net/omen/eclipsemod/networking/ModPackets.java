...
public class ModPackets {
    ...
    public static void register() {
        ...
        net.messageBuilder(ExecuteAbilityPacket.class, id())
                .decoder(ExecuteAbilityPacket::new)
                .encoder(ExecuteAbilityPacket::toBytes)
                .consumerMainThread(ExecuteAbilityPacket::handle)
                .add();
