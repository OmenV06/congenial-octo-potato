...
import net.omen.eclipsemod.networking.packets.ExecuteAbilityPacket;
        ...
        private static void handleAbilityKeyInput() {
            ...
            if (KeyBindings.ABILITY_ONE.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(0));
                } else {
            ...
            if (KeyBindings.ABILITY_TWO.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(1));
                } else {
            ...
            if (KeyBindings.ABILITY_THREE.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(2));
                } else {
            ...
            if (KeyBindings.ABILITY_FOUR.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(3));
                } else {
            ...
            if (KeyBindings.ABILITY_FIVE.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(4));
                } else {
            ...
            if (KeyBindings.ABILITY_SIX.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(5));
                } else {
            ...
            if (KeyBindings.ABILITY_SEVEN.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(6));
                } else {
            ...
            if (KeyBindings.ABILITY_EIGHT.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(7));
                } else {
            ...
            if (KeyBindings.ABILITY_NINE.consumeClick()) {
                if (AbilityBar.isActive()) {
                    ModPackets.sendToServer(new ExecuteAbilityPacket(8));
                } else {
